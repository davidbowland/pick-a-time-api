...
export CORS_DOMAIN='https://pick-a-time.bowland.link'
export CREATE_SESSION_FUNCTION_NAME='create-session-local'
export CREATE_SESSION_TIMEOUT_MS='80000'
export DYNAMODB_TABLE_NAME=pick-a-time-api-sessions-test
...
sam local start-api --region=us-east-1 --force-image-build --parameter-overrides "Environment=test RecaptchaSecretKey=$RECAPTCHA_SECRET_KEY SmsApiKey=$SMS_API_KEY" --log-file local.log
